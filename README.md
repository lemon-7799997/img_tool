...
- **atlas** — pack images into a single sprite atlas with tight packing or uniform-grid layout (uniform-grid cells use the same `--stretch`/`--align` controls as **resize**)
